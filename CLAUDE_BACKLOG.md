# Backlog — Backlog_sweep

Ordered highest value → lowest value. Max 2 items get worked per
overnight run (see CLAUDE.md).
...
- [ ] (add refactor tasks here as they come up) — ♻️

## 🟢 Low value / nice-to-have

- [ ] (add research tasks here as they come up) — 🔬
